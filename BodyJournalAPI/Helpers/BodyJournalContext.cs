...
namespace BodyJournalAPI.Helpers
{
  public class BodyJournalContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      ...
      //c1 and c3
      new Workout { Id = 5, Name = "Chest day", TimeOfWorkout = DateTime.Now, Satisfaction = 5, IntensityScore = 8 },
      //9 and 12
      new Workout { Id = 6, Name = "Arms day", TimeOfWorkout = DateTime.Now, Satisfaction = 5, IntensityScore = 8 },
      //legs 17,(2) and 20,(4)
      new Workout { Id = 7, Name = "Legs day", TimeOfWorkout = DateTime.Now, Satisfaction = 5, IntensityScore = 6 }
  );
      #endregion
      ...
      builder.Entity<ExerciseWorkout>().HasData(
        ...
        // Legs Day
        new ExerciseWorkout { Id = 15, ExerciseId = 18, WorkoutId = 8 },
        new ExerciseWorkout { Id = 16, ExerciseId = 19, WorkoutId = 8 }

     );
      #region MuscleGroupFatigue
      builder.Entity<MuscleGroupFatigue>().HasData(
      new MuscleGroupFatigue { Id = 1, MuscleGroup = "Chest", Fatigue = 3, CurrentTime = DateTime.Now, WorkoutId = 5 },
      ...
      new MuscleGroupFatigue { Id = 4, MuscleGroup = "Legs", Fatigue = 5, WorkoutId = 7 },
